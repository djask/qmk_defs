...
// for some reason aliases for int keys are not working anymore
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
    KC_PAUS, _______,      KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,    KC_PSCR, KC_SCRL, _______,        KC_F13  , KC_F14 , KC_F15 , KC_F16 ,
                                                                                                                     KC_INS , KC_HOME, KC_PGUP,        KC_F17  , KC_F18 , KC_F19 , KC_F20 ,
    KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_INT3, KC_BSPC,           KC_DEL , KC_END , KC_PGDN,
    ...
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_INT1,                            KC_LEFT, KC_DOWN, KC_RGHT ,       KC_P4   , KC_P5  , KC_P6  , KC_PDOT,
        KC_LGUI, KC_LALT,            KC_SPC,                     KC_RALT, KC_INT2, KC_RCTL,                                                            KC_P1   , KC_P2  , KC_P3  , KC_PENT,
                       KC_INT5, KC_INT4,                                                                                      MO(1)   ,                       KC_P0,      _______
    ), 
    [1] = LAYOUT(
