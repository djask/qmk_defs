...
[0] = LAYOUT(
    ...
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    QK_BOOT,  QK_BOOT, KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                      KC_LGUI, KC_SPC,  KC_LALT, MO(1)  , MO(2),    MO(2),   MO(1),    KC_SPC,   KC_UNDS, KC_RGUI
),
[1] = LAYOUT(
    ...
    KC_CAPS, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,                    KC_DEL,  KC_END,  KC_PGDN, KC_LPRN, KC_RPRN, KC_QUOT,
