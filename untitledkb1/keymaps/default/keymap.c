...
[0] = LAYOUT(
  KC_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   ,KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_EXLM, KC_EQL  ,KC_BSPC,
  ...
  KC_NO ,  KC_CAPS, KC_LGUI, KC_LALT, MO(1),           ,KC_SPC,  KC_SPC,  KC_RGUI,          KC_RGHT,  KC_DOWN, KC_UP   ,KC_LEFT, 
),
[1] = LAYOUT(
