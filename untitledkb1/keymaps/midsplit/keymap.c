...
[1] = LAYOUT(
  KC_GRV , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_WH_U, KC_ASUP, KC_ACL0,_______,KC_BTN2, _______, KC_MINS, KC_EQL , _______, 
  _______, KC_F5  , KC_F6  , KC_F7  , KC_F8  , KC_WH_D, KC_ASDN, KC_ACL1,KC_WH_U,KC_BTN1, KC_MS_U, KC_LBRC, KC_RBRC, _______, 
  _______, KC_F9  , KC_F10 , KC_F11 , KC_F12 , KC_WH_L, KC_ASRP, KC_ACL2,KC_WH_D,KC_MS_L, KC_MS_D, KC_MS_R, _______, KC_QUOT,
  _______, _______, _______, _______, _______, _______, KC_ASTG, KC_WH_L,KC_WH_R,_______, _______, _______, _______, _______, 
  _______, _______, _______, _______, _______,          QK_BOOT, NK_TOGG,KC_MINS,         _______, _______, _______, _______
),
[2] = LAYOUT(
